...
import (
	...
	endpoint "github.com/sureeratk/go-micro-service-w-go-kit/bugs/pkg/endpoint"
	http "github.com/sureeratk/go-micro-service-w-go-kit/bugs/pkg/http"
	service "github.com/sureeratk/go-micro-service-w-go-kit/bugs/pkg/service"
	"net"
	http1 "net/http"
	"os"
	"os/signal"
