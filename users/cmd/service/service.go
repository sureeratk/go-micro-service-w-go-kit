...
import (
	...
	endpoint "github.com/sureeratk/go-micro-service-w-go-kit/users/pkg/endpoint"
	http "github.com/sureeratk/go-micro-service-w-go-kit/users/pkg/http"
	service "github.com/sureeratk/go-micro-service-w-go-kit/users/pkg/service"
	"net"
	http1 "net/http"
	"os"
	"os/signal"
